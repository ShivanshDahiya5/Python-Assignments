...
DATA_FILE = "weather.csv"   # default filename the script expects
...
def make_sample_weather_csv(path=DATA_FILE):
    ...
    # Create synthetic realistic-ish data:
...
def load_dataset(filename=DATA_FILE):
    ...
    # Normalize possible column names (try to be flexible)
    rename_map = {}
